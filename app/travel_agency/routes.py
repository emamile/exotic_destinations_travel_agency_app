...
def create_travel_agency(travel_agency: TravelAgencySchemaIn):
    return TravelAgencyController.create_travel_agency(
        name=travel_agency.name,
        email=travel_agency.email,
        password=travel_agency.password,
        address=travel_agency.address,
...
def update_travel_agency_email_and_password(travel_agency_id: str, email: EmailStr, password: str):
    return TravelAgencyController.update_travel_agency_email_and_password(
